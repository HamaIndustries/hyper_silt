...
public class HyperSilt implements ModInitializer {
    ...
    public static final RegistryKey<Item> OMNI_CLAY_KEY = RegistryKey.of(RegistryKeys.ITEM, id("omni_clay"));
    public static final Item OMNI_CLAY = Registry.register(Registries.ITEM, OMNI_CLAY_KEY, new Item(new Item.Settings()
            .registryKey(OMNI_CLAY_KEY)
            .maxCount(1)
    ...
    public static final TagKey<Item> SPEEDRUNNING_SOILS = TagKey.of(RegistryKeys.ITEM, Identifier.of("c", "speedrunning_soils"));
...
//		ServerEntityEvents.ENTITY_LOAD.register((entity, serverWorld) -> entity.setAttached(HYPER, true));
    ...
    private static void hyperize(MinecraftServer server) {
        for (PlayerEntity player : server.getPlayerManager().getPlayerList()) {
            ...
            if (player.getStackInHand(Hand.MAIN_HAND).isIn(SPEEDRUNNING_SOILS) && hyper) {
